...
namespace Utils
{
    public static class AdManager
    {
        ...
        {
            if (Kimicu.YandexGames.Advertisement.AdvertisementIsAvailable && !SaveManager.PurchasesData.NoAds && !_inAd)
            {
                _inAd = true;
            ...
            else
            {
                Debug.Log($"Cant show inter. AdvertisementIsAvailable: {Kimicu.YandexGames.Advertisement.AdvertisementIsAvailable}. "
                          + $"No ads: {SaveManager.PurchasesData.NoAds}. In Ad: {_inAd}");
